"""init: create all tables with score

Revision ID: a1d4515c3b31
Revises:
Create Date: 2026-01-12 15:22:16.285466
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("score", sa.Integer(), nullable=True, comment="Score of the post"),
